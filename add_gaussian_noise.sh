...
show_help() {
    echo "Description:"
    echo "  Add Gaussian noise to images. Core functionality is in add_guassian_noise_to_images.py"
    echo
...
main() {
    ...
    python3 add_gaussian_noise_to_images.py "$IMAGES_DIR" "$DETECTIONS_DIR" "$OUTPUT_DIR" "$METHOD"
}
# ==============================================================
